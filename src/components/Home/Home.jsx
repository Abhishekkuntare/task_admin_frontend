        ...
        <div className="flex flex-col justify-center px-4 py-10 lg:px-6">
          ...
          <div className="mt-10 flex max-w-max items-center space-x-2 rounded-full border p-2">
            <p className="text-xs font-medium md:text-sm">
              Admins can create, modify, or delete user accounts
          ...
          <p className="mt-8 max-w-3xl text-lg text-gray-700">
            An admin panel, short for administration panel, is a web-based
            interface designed to manage and control various aspects of a
            software application, website, or system.
          </p>
          <div className="mt-8">
            <Link to={"/profile"}>
              <button
